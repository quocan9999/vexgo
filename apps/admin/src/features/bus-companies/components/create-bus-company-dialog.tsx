...
export function CreateBusCompanyDialog({
  ...
  return (
    <dialog
      ...
      ref={dialogRef}
    >
      <section className="create-company-panel">
        <div className="detail-heading create-company-heading">
        ...
        >
          <p className="create-company-intro">
            Nhập thông tin cơ bản để thêm đối tác vào hệ thống.
          </p>

          {formError && (
            <div className="create-company-form-error" role="alert">
              {formError}
            </div>
          )}
          ...
          <div className="create-company-field">
            ...
            {fieldErrors.code && (
              <span
                className="create-company-field-error"
